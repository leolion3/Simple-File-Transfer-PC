...
import static software.isratech.easy_file_transferer.net.Communication.receiveMessage;
import static software.isratech.easy_file_transferer.net.Communication.sendMessage;
...
public class Server {
    ...
    public void serve(
        ...
        handleClient(clientSocket, file);
    }
    ...
    private void handleClient(
        ...
        handleFileTransfer(socketOutputStream, file, existingFileSize);
